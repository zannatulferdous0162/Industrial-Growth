    ...
    <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
        <div className="mb-4">
            <div className="mb-6 max-w-3xl text-center sm:text-center md:mx-auto md:mb-12">
                ...
                <h2
                    className="font-heading py-4 font-bold tracking-tight text-gray-900 dark:text-white text-3xl sm:text-5xl">
                  Contact Us
                </h2>
            </div>
        </div>
            ...
            <div className="grid md:grid-cols-2">
                <div className="h-full pr-6">
                    <p className="mt-3 mb-12 text-lg text-gray-600 dark:text-slate-400">
                       Any Other Information In Our Details Contact Us
                    </p>
                    <ul className="mb-6 md:mb-0">
                        <li className="flex">
                            ...
                            <div className="ml-4 mb-4">
                                ...
                                <p className="text-gray-600 dark:text-slate-400">USA</p>
                        ...
                        <li className="flex">
                            ...
                            <div className="ml-4 mb-4">
                                ...
                                <p className="text-gray-600 dark:text-slate-400">Mobile: +1 456-7890</p>
                                <p className="text-gray-600 dark:text-slate-400">Mail: contact@gmail.com</p>
                            </div>
                        </li>
                        <li className="flex">
                            <div className="flex h-10 w-10 items-center justify-center rounded bg-blue-900 text-gray-50">
                            ...
                            <div className="ml-4 mb-4">
                                <h3 className="mb-2 text-lg font-medium leading-6 text-gray-900 dark:text-white">Working
                                    hours</h3>
                                <p className="text-gray-600 dark:text-slate-400">SunDay To ThusDay: 08:00 - 17:00</p>
